...
namespace ApiBase.Repository.Infrastructure
{
    public interface IRepository<T> where T : class
    {
        ...
        Task<IEnumerable<T>> ThongKe1(dynamic listId);
        Task<IEnumerable<T>> ThongKeThuChi(List<KeyValuePair<string, dynamic>> columns);
        Task<IEnumerable<T>> ThongKeThuNhap(List<KeyValuePair<string, dynamic>> columns);
        Task<IEnumerable<T>> ThongKeThuNhapTheoLoai(List<KeyValuePair<string, dynamic>> columns);
         Task<IEnumerable<T>> ThongKeChiTieuTheoLoai(List<KeyValuePair<string, dynamic>> columns);
        Task<IEnumerable<T>> TKTop5Customer(List<KeyValuePair<string, dynamic>> columns);
        Task<IEnumerable<T>> TKTop5ProductBC(List<KeyValuePair<string, dynamic>> columns);
        Task<T> ThongKeChiTieuTheoThang(dynamic month, dynamic year, dynamic status);
        Task<T> ThongKeThuNhapTheoThang(dynamic month, dynamic year, dynamic status);
        Task<T> ThongKeHoaDonCXL(dynamic date, dynamic status);
        ...
        Task<int> DeleteMultiByListConditionAndAsync(List<KeyValuePair<string, dynamic>> columns);
    ...
    public abstract class RepositoryBase<T> : IRepository<T> where T : class
    {
        ...
        public async Task<IEnumerable<T>> ThongKeThuNhap(List<KeyValuePair<string, dynamic>> columns)
        {
            try
            {
                using (var conn = CreateConnection())
                {
                    ...
                    return await conn.QueryAsync<T>("THONG_KE_THU_NHAP", parameters, null, null, CommandType.StoredProcedure);
                }
            }
            catch (SqlException ex)
            {
        ...
        public async Task<IEnumerable<T>> ThongKeThuChi(List<KeyValuePair<string, dynamic>> columns)
        {
            try
            {
                using (var conn = CreateConnection())
                {
                    ...
                    parameters.Add("@listColumn", JsonConvert.SerializeObject(columns));
                    return await conn.QueryAsync<T>("THONG_KE_THU_CHI", parameters, null, null, CommandType.StoredProcedure);
                }
            }
            catch (SqlException ex)
            {
        ...
        public async Task<IEnumerable<T>> ThongKeChiTieuTheoLoai(List<KeyValuePair<string, dynamic>> columns)
        {
            try
            {
                using (var conn = CreateConnection())
                {
                    ...
                    parameters.Add("@listColumn", JsonConvert.SerializeObject(columns));
                    return await conn.QueryAsync<T>("THONG_KE_CHI_TIEU_THEO_LOAI", parameters, null, null, CommandType.StoredProcedure);
                }
            }
            catch (SqlException ex)
            {
        ...
        public async Task<IEnumerable<T>> ThongKeThuNhapTheoLoai(List<KeyValuePair<string, dynamic>> columns)
        {
            try
            {
                using (var conn = CreateConnection())
                {
                    ...
                    parameters.Add("@listColumn", JsonConvert.SerializeObject(columns));
                    return await conn.QueryAsync<T>("THONG_KE_THU_NHAP_THEO_LOAI", parameters, null, null, CommandType.StoredProcedure);
                }
            }
            catch (SqlException ex)
            {
        ...
        public async Task<IEnumerable<T>> TKTop5Customer(List<KeyValuePair<string, dynamic>> columns)
        {
            try
            {
                using (var conn = CreateConnection())
                {
                    ...
                    parameters.Add("@listColumn", JsonConvert.SerializeObject(columns));
                    return await conn.QueryAsync<T>("TOP_5_CUSTOMER", parameters, null, null, CommandType.StoredProcedure);
                }
            }
            catch (SqlException ex)
            {
        ...
        public async Task<IEnumerable<T>> TKTop5ProductBC(List<KeyValuePair<string, dynamic>> columns)
        {
            try
            {
                using (var conn = CreateConnection())
                {
                    ...
                    parameters.Add("@listColumn", JsonConvert.SerializeObject(columns));
                    return await conn.QueryAsync<T>("TOP_5_PRODUCT_BC", parameters, null, null, CommandType.StoredProcedure);
                }
            }
            catch (SqlException ex)
            {
        ...
        public async Task<IEnumerable<T>> ThongKe1(dynamic listId)

        //dynamic keiu vo danh
        //KeyValuePair luu tru cap gia tri
        //DynamicParameters Doi so dong

        {
            ...
            try
            {
                using (var conn = CreateConnection())
                {
                    ...
                    parameters.Add("@year", JsonConvert.SerializeObject(listId));
                    //SerializeObject tra ra 1 chuoi columns {id,tensp, giaban....}
                    return await conn.QueryAsync<T>("THONG_KE", parameters, null, null, CommandType.StoredProcedure);
                }
            }
            catch (SqlException ex)
            {
        ...
        public virtual async Task<T> ThongKeChiTieuTheoThang(dynamic month,dynamic year,dynamic status)
        {
            try
            {
                string query = $"SELECT sum(total) as total FROM Bills WHERE Month(dateCreated) = N'{month}' AND YEAR(dateCreated)=N'{year}' AND statusId=N'{status}'";
                using (var conn = CreateConnection())
                {
                    return await conn.QueryFirstOrDefaultAsync<T>(query, null, null, null, CommandType.Text);
                }
        ...
        public virtual async Task<T> ThongKeThuNhapTheoThang(dynamic month, dynamic year, dynamic status)
        {
            try
            {
                string query = $"SELECT sum(total) as total FROM Orders WHERE Month(dateCreated) = N'{month}' AND YEAR(dateCreated)=N'{year}' AND statusId=N'{status}'";
                using (var conn = CreateConnection())
                {
                    return await conn.QueryFirstOrDefaultAsync<T>(query, null, null, null, CommandType.Text);
                }
        ...
        public virtual async Task<T> ThongKeHoaDonCXL(dynamic date,dynamic status)
        {
            try
            {
                string query = $"SELECT Count(id) as total FROM Orders WHERE Month(dateCreated) = N'{date}' and statusId!=N'{status}'";
                using (var conn = CreateConnection())
                {
                    return await conn.QueryFirstOrDefaultAsync<T>(query, null, null, null, CommandType.Text);
                }
        ...
        public async Task<IEnumerable<T>> GetMultiByListConditionAndAsyncOther(List<KeyValuePair<string, dynamic>> columns)
        {
            try
            {
                using (var conn = CreateConnection())
                {
                    ...
                    parameters.Add("@tableName", _table);
                    parameters.Add("@listColumn", JsonConvert.SerializeObject(columns));
                    return await conn.QueryAsync<T>("GET_MULTI_DATA_AND_other", parameters, null, null, CommandType.StoredProcedure);
                }
            }
            catch (SqlException ex)
            {
        ...
        public virtual async Task<int> DeleteMultiByListConditionAndAsync(List<KeyValuePair<string, dynamic>> columns)
        {
            try
            {
                using (var conn = CreateConnection())
                {
                    ...
                    parameters.Add("@tableName", _table);
                    parameters.Add("@listColumn", JsonConvert.SerializeObject(columns));
                    return await conn.ExecuteAsync("DELETE_OP", parameters, null, null, CommandType.StoredProcedure);
                }
            }
            catch (SqlException ex)
            {

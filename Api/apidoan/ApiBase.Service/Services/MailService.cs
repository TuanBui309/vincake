...
namespace ApiBase.Service.Services
{
    ...
    {
        Task SendMailAsync(string toName, string toEmail,string content);
    }
    ...
    public class MailService : IMailService
    {
        ...
        public async Task SendMailAsync(string toName, string toEmail,string content)
        {
            ...
            try
            {
                ...
                bodyBuilder.HtmlBody = "Mã xác thực của bạn là: "+content;

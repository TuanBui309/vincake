...
namespace ApiBase.Api.Controllers
{
    ...
    {
        IStatusOrderService _statusOrderServicer;

        public StatusOrderController(IStatusOrderService statusServicer)
        {
            _statusOrderServicer = statusServicer;
        }
        ...
        public async Task<IActionResult> getAll()
        {
            ...
            var result = await _statusOrderServicer.GetAllAsync();
            return result;
        }

...
import { UPDATE_USER_SAGA } from '../../../redux/constants/User/User';





function FormEditedUser(props) {
            ...
            <div className="row">
                <div className="col-4">
                    ...
                    <div className="form-group">
                        <p className="font-weight-bold">Mã Nhân Viên</p>
...
const mapStateToProps = (state) => ({
    ...
    editUser: state.UsersReducers.editUser

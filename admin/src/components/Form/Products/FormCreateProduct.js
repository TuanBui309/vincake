            ...
            <div className="row">
                ...
                <div className="col-6">
                    <div className="form-group">
                        ...
                        <input   className="form-control" name="tenSP" onChange={handleChange} {...getFieldProps("tenSP")}/>
                ...
                <div className="col-6">
                    <div className="form-group">
                        ...
                        <select className="form-control" name="maLoai"  onChange={handleChange} {...getFieldProps("maLoai")}>
                ...
                <div className="col-6">
                    <div className="form-group">
                        ...
                        <input  className="form-control" name="giaBan" onChange={handleChange} {...getFieldProps("giaBan")} />
                ...
                <div className="col-6">
                    <div className="form-group">
                        ...
                        <input  className="form-control" name="sale" onChange={handleChange} {...getFieldProps("sale")}/>
                ...
                <div className="col-6">
                    <div className="form-group">
                        ...
                        <input  className="form-control" name="soLuong" onChange={handleChange} {...getFieldProps("soLuong")}/>
                ...
                <div className="col-6">
                    <div className="form-group">
                        ...
                        <input  className="form-control" name="tinhTrang" onChange={handleChange} {...getFieldProps("tinhTrang")} />
...
const mapStateToProps = (state) => ({
    ...
    categoriesList: state.CategoriesReducers.categoriesList
